...
<img
  src="../images/keyvault_managed_service_identity.png"
  class="center"
  alt="Enable Managed Service Identity for Azure App Service"
/>
...
<img
  src="../images/kkeyvault_msi_tenantId.png"
  class="center"
  alt="Get Tenant Id and AppId"
/>
