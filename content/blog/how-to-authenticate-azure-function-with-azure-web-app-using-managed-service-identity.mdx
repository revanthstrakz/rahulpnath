...
Managed Serviced Identity (MSI) can be turned on through the Azure Portal. Under 'Platform features' for an Azure Function select '_Identity_' as shown below and turn it on for _System Assigned_.
...
Once enabled, you can find the added identity for the Azure function under _Enterprise Applications_ list in the AD directory. Azure internally manages this identity.
